...
st.markdown("""<style>
:root{--ink:#10213e;--muted:#60708b;--blue:#2563eb;--navy:#0b1830;--line:#dce5f1}.stApp,[data-testid=stAppViewContainer]{background:#f4f7fb;color:var(--ink)}.block-container{max-width:1450px;padding-top:2rem}h1{font-size:2.45rem;font-weight:760;letter-spacing:-.05em}h1,h2,h3,p,label,[data-testid=stMarkdownContainer]{color:var(--ink)}[data-testid=stSidebar]{background:var(--navy)}[data-testid=stSidebar] h1,[data-testid=stSidebar] h2,[data-testid=stSidebar] h3,[data-testid=stSidebar] label{color:#fff!important}[data-testid=stSidebar] label{font-weight:650!important}[data-testid=stSidebar] [data-testid=stCaptionContainer],[data-testid=stSidebar] small{color:#cbd5e1!important}[data-testid=stSidebar] [data-baseweb=input],[data-testid=stSidebar] [data-baseweb=select]>div,[data-testid=stSidebar] [data-testid=stDateInput] [data-baseweb=input]{background:#f8fafc!important;border-color:#64748b!important;color:#0f172a!important}[data-testid=stSidebar] input,[data-testid=stSidebar] [data-baseweb=input] input{background:transparent!important;color:#0f172a!important;-webkit-text-fill-color:#0f172a!important}[data-testid=stSidebar] input::placeholder{color:#475569!important;-webkit-text-fill-color:#475569!important;opacity:1!important}[data-testid=stSidebar] [data-baseweb=select] [role=combobox],[data-testid=stSidebar] [data-baseweb=select] [role=combobox] *{color:#0f172a!important}[data-testid=stSidebar] [data-baseweb=select] [data-baseweb=tag]{background:#dbeafe!important}[data-testid=stSidebar] [data-baseweb=select] [data-baseweb=tag] *{color:#1e3a8a!important}[data-baseweb=popover],[data-baseweb=menu]{background:#fff!important;color:#0f172a!important}[data-baseweb=popover] *,[data-baseweb=menu] *{color:#0f172a!important}[data-testid=stSidebar] [data-testid=stFileUploaderDropzone]{background:#14294d;border:1px dashed #5b7ead}[data-testid=stSidebar] [data-testid=stFileUploaderDropzone] span,[data-testid=stSidebar] [data-testid=stFileUploaderDropzone] small{color:#e7f0ff!important}[data-testid=stSidebar] [data-testid=stFileUploaderDropzone] button,[data-testid=stSidebar] [data-testid=stButton] button{background:#2563eb!important;color:#fff!important;border:0!important}[data-testid=stSidebar] [data-testid=stFileUploaderDropzone] button *,[data-testid=stSidebar] [data-testid=stButton] button *{color:#fff!important}[data-testid=stSidebar] [data-testid=stButton] button:hover{background:#1d4ed8!important}[data-testid=stSidebar] [data-baseweb=slider] [role=slider]{background:#2563eb!important}[data-testid=stSidebar] [data-baseweb=slider]~div,[data-testid=stSidebar] [data-testid=stSlider] div{color:#cbd5e1}[data-testid=stMetric]{background:#fff;border:1px solid var(--line);border-radius:14px;padding:15px;box-shadow:0 4px 14px #233e6c12}[data-baseweb=tab-list]{gap:.4rem;border-bottom:1px solid var(--line)}button[data-baseweb=tab]{color:#5f6f88;font-weight:650}.hero{background:linear-gradient(110deg,#0b1830,#173c7a 62%,#2563eb);border-radius:18px;padding:24px 29px;margin:0 0 1.35rem}.hero h2{color:#fff;margin:0}.hero p{color:#dbeafe}.insight{background:#fff;border:1px solid var(--line);border-left:4px solid #2563eb;border-radius:10px;padding:12px 14px;margin:7px 0;color:#223555}</style>""",unsafe_allow_html=True)
...
[data-testid="stSidebar"] [data-testid="stSlider"] label { color:#fff !important; }
[data-testid="stSidebar"] [data-testid="stAlert"] * { color:#e6fffb !important; }
</style>""", unsafe_allow_html=True)
